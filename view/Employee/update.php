...
<script>
    $(function() {
        ...
        // PRODUCT
        if (modif === "produit") {
            $.getJSON("https://bikestoresab.alwaysdata.net/bikestores/api.php?actionGet=product&id=" + id, function(data) {
                ...
                $.when(
                    $.getJSON("https://bikestoresab.alwaysdata.net/bikestores/api.php?actionGet=brands"),
                    $.getJSON("https://bikestoresab.alwaysdata.net/bikestores/api.php?actionGet=categories")
                ...
                $("#submit").off("click").on("click", function(e) {
                    e.preventDefault();
                    $.ajax({
                        url: `https://bikestoresab.alwaysdata.net/bikestores/api.php?actionPut=updateProduct&id=${$("#product_id").val()}&name=${$("#product_name").val()}&modelyear=${$("#model_year").val()}&listprice=${$("#product_price").val()}&category=${$("#category_id").val()}&brand=${$("#brand_id").val()}&KEY=e8f1997c763`,
                        type: "PUT",
                        dataType: "json",
        ...
        // BRAND
            ...
            $.getJSON("https://bikestoresab.alwaysdata.net/bikestores/api.php?actionGet=brand&id=" + id, function(data) {
        ...
        // CATEGORY
            ...
            $.getJSON("https://bikestoresab.alwaysdata.net/bikestores/api.php?actionGet=categorie&id=" + id, function(data) {
        ...
        // STOCK
            ...
            $.getJSON("https://bikestoresab.alwaysdata.net/bikestores/api.php?actionGet=stock&id=" + id, function(data) {
                let stock = data[0];
        ...
        // STORE
            ...
            $.getJSON("https://bikestoresab.alwaysdata.net/bikestores/api.php?actionGet=store&id=" + id, function(data) {
                let store = data[0];
