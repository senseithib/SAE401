...
<head>
    ...
    if ($page == "gestionIT") {
        echo '<link href="style/IT/gestionIT.css" rel="stylesheet" />';
    }
    if ($page == "insert") {
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link text-white fw-semibold" href="index.php?action=accueilIT">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white fw-semibold" href="index.php?action=magasinIT">Stores</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white fw-semibold" href="index.php?action=GestionIT">Management</a>
                    </li>
                </ul>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="index.php?action=accountIT" class="text-white text-decoration-none d-flex align-items-center icon">
